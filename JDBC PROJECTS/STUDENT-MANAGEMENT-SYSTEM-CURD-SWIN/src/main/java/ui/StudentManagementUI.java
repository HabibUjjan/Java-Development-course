 ...
 * @author HABIB
 */
public class StudentManagementUI extends javax.swing.JFrame {

    /**
     * Creates new form StudentManagementUI
     */
...
private void fillDepartments() {
    ...
    for (Department dept : departments) {
        jComboBox2.addItem(dept.getName());
    }
}
    ...
    private void initComponents() {
        ...
        jLabel1.setForeground(new java.awt.Color(239, 56, 193));
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("STUDENT MANAGEMENT SYSTEM CRUD");
    ...
    gender = jRadioButton1.getText(); // male
    } else if (jRadioButton2.isSelected()) {
    gender = jRadioButton2.getText(); // female
}
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
       // Delete button action code example

// Suppose id ya rollNumber se delete karna hai
String rollNumber = jTextField3.getText();  // ya jahan se id ya roll number le rahe ho
...
javax.swing.JOptionPane.showMessageDialog(this, "Student deleted successfully!");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // Update button action code example
...
javax.swing.JOptionPane.showMessageDialog(this, "Student updated successfully!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StudentManagementUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
